...
// Store load failed.  Set this as your "exception" handler on your Stores
...
// display the first error which arrives for each page.  Call the next
// method down before each set of loading, to reset the error display flag.
//
var done_alert = 0;
