...
#BuildRequires:
Requires: httpd perl(CGI) perl(CGI::Session) perl(CGI::Cookie) perl(HTTP::Cookies) perl(MIME::Types) perl(DBI) perl(JSON) perl(XML::Parser) perl(Digest::MD5) perl(Time::HiRes)
